if IY_LOADED and not _G.IY_DEBUG == true then
	--notify("Error", "Infinite Yield is already running!")
	return
end
...
if not game:IsLoaded() then
	...
	notLoaded.Text = "InfY-S is waiting for the game to load"
	game.Loaded:Wait()
	notLoaded:Destroy()
end

currentVersion = "InfY-S V1.0.0 [RELEASE]"
...
ReferenceButton.Image = "rbxassetid://83420069652093" -- 3523243755
...
CMDs[#CMDs + 1] = {NAME = 'invisiblegui / invisgui' , DESC = 'Opens invisible on/off gui'}
CMDs[#CMDs + 1] = {NAME = 'aimbot' , DESC = 'Turns on aimbot'}
CMDs[#CMDs + 1] = {NAME = 'noaimbot' , DESC = 'Turns off aimbot'}
...
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'esp / unnamedesp', DESC = 'View all players and their status'}
...
addcmd('saveinstance',{},function(args, speaker)
	local Params = {
		RepoURL = "https://raw.githubusercontent.com/uwpy/Infy-S-Scripts/refs/heads/main/",
		SSI     = "synxsaveinstance",
	}
	local synxsaveinstance = loadstring(game:HttpGet(Params.RepoURL .. Params.SSI .. ".luau", true), Params.SSI)()
	local Options = { IsolatePlayers = true }
	synxsaveinstance(Options)
end)

addcmd('pfling',{},function(args, speaker)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/uwpy/InfY-S-Scripts/aodyasdasdsad.lua"))();
end)

addcmd('backdoor',{},function(args, speaker)
...
addcmd('esp', {'unnamedesp'}, function(args, speaker)
...
addcmd('kick', {}, function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players)do
		Players:Kick()
	end
...
addcmd('noaimbot',{},function(args, speaker)
	_G.AimbotEnabled = false
	_G.CircleVisible = false
end)

addcmd('outofprison', {}, function(args, speaker)
	local player = game.Players.LocalPlayer
	local targetPosition = Vector3.new(-919, 95, 2134)
...
addcmd('synapsexreal',{},function(args, speaker)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/uwpy/Infy-S-Scripts/refs/heads/main/Synapse%20X%20rework.lua"))()
end)

addcmd('syndex', {'dex'}, function(args, speaker)
	notify('Loading', 'Hold on a sec')
	loadstring(game:HttpGet("https://raw.githubusercontent.com/uwpy/Infy-S-Scripts/refs/heads/main/DarkDex-Mobile.lua"))()
end)

addcmd('invisiblegui', {'invisgui'}, function(args, speaker)
	notify('Loading', 'Hold on a sec')
	loadstring(game:HttpGet("https://raw.githubusercontent.com/uwpy/Infy-S-Scripts/refs/heads/main/sajhdgajdajdwww.lua"))()
end)

addcmd('flynoclip', {'flnoc'}, function(args, speaker)
	notify('Loading', 'Hold on a sec')
	loadstring(game:HttpGet("https://raw.githubusercontent.com/uwpy/Infy-S-Scripts/refs/heads/main/Script"))()
end)
		...
		if v.Character and v.Character:FindFirstChild("Head") then
			for _, part in pairs(workspace:GetDescendants()) do
				if part:IsA("BasePart") or part:IsA("UnionOperation") or part:IsA("Model") then
					if part.Anchored == false and not part:IsDescendantOf(speaker.Character) and
						...
						-- Remove existing BodyPosition and BodyGyro instances
						...
						-- Create a new BodyPosition instance
						...
						-- Ensure frozenParts is defined
						if not frozenParts then frozenParts = {} end
			...
			-- Apply position to all forced parts
